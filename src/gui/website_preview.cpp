...
WebsitePreview::WebsitePreview(WebsiteSnapshot *websiteSnapshotP, bool showCropDialog, bool crop, QRect cropArea, QWidget *parent) :
    QDialog(parent),
...
void WebsitePreview::beginCropDialog(QImage *image){
    if(!image || image->isNull()){
        QMessageBox::warning(this, tr("Error!"), tr("There was an error while processing your request!"));
    }
    else
    {
        ...
        cropImageDialog_->activateWindow();
