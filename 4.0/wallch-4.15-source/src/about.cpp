    ...
    ui(new Ui::about)
{
    ...
    ui->wallch_version_label->setText("Wallch "+QString::number(APP_VERSION, 'f', 2));
    ...
    ui->artworkBy->append(QString("Kostis Solanos &lt;<a href= http://kozysolanos.tumblr.com ><span style=\" font-family:'Ubuntu'; font-size:11pt; text-decoration: underline; color:#ff5500;\">kozysolanos.tumblr.com</span></a>, ")
                          +"<a href= http://solanos.deviantart.com/ ><span style=\" font-family:'Ubuntu'; font-size:11pt; text-decoration: underline; color:#ff5500;\">solanos.deviantart.com</span></a>&gt;");
    ui->artworkBy->append(tr("\nThe screen used for the preview:"));
    ui->artworkBy->append("Vlad Gerasimov &lt;<a href= http://www.vladstudio.com/ ><span style=\" font-family:'Ubuntu'; font-size:11pt; text-decoration: underline; color:#ff5500;\">vladstudio.com</span></a>&gt;");
