...
apt-get install debhelper qt5-qmake qttools5-dev-tools libqt5core5a libqt5widgets5 qtbase5-dev libqt5network5 libqt5dbus5 libnotify-dev libkeybinder-dev libdee-dev libexif-dev libappindicator3-1 libglib2.0-dev qtdeclarative5-dev libqt5opengl5-dev libgstreamer-plugins-base1.0-dev libsqlite3-dev libxslt1-dev libqt5webkit5-dev || (error_report "installing build dependencies failed")
