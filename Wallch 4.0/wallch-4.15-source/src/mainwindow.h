...
class MainWindow : public QMainWindow {
    Q_OBJECT
public:
    MainWindow(Global *globalParser, WebsiteSnapshot *websiteSnapshot, WallpaperManager *wallpaperManager, int timeout_count, int last_random_delay, QWidget *parent = 0);
    ~MainWindow();
